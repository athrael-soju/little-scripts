    ...
    def _register_commands(self):
        ...
        commands = [
            ...
            Command(
                ...
                aliases=["clear-collection"],
                command_type=CommandType.CLEAR,
                description="Clear all documents and images from the collection (destructive operation)",
                help_text="Clear the collection and images",
                emoji="🗑️",
                requires_args=False,
            ),
            Command(
                ...
                description="Show current system status and collection information",
